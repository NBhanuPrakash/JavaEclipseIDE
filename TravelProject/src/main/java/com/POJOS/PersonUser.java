...
public class PersonUser {
	...
	public PersonUser(String fullName, String mobileNString, String genderString, String emailIdString,
	...
	public String toString() {
		return "PersonUser [fullName=" + fullName + ", mobileNString=" + mobileNString + ", genderString=" + genderString
